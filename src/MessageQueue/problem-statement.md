...
### Bonus
* We should be able to reset the offset of the subscriber. This means subscriber should restart reading from that offset. It is like replaying the messages.