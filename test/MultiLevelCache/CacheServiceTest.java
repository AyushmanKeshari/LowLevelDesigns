...
import MultiLevelCache.policy.LRUEvictionPolicy;
import MultiLevelCache.provider.CacheProvider;
import MultiLevelCache.provider.DefaultLevelCache;
import MultiLevelCache.provider.NullEffectLevelCache;
import MultiLevelCache.service.CacheService;
import MultiLevelCache.storage.InMemoryStorage;
...
public class CacheServiceTest {
    ...
    private CacheProvider<String, String> createCache(int capacity) {
        return new CacheProvider<>(new InMemoryStorage<>(capacity), new LRUEvictionPolicy<>());
    }
}
